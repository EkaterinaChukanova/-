...
Имя               | Роль в проекте
------------------|---------------------
Валерия Никишина  | ast и парсер
Екатерина Чуканова| интерпретатор и рекурсия
Ирина Бычкова     | примеры и документация


## Авторы
- Валерия Никишина — архитектор языка
- Екатерина Чуканова — инженер исполнения
- Ирина Бычкова — экосистема языка

## Примеры
Файлы в папке `examples/`: factorial, fibonacci, fizzbuzz, quicksort, y_combinator
